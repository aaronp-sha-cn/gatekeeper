...
# - 先 apt-get update（使用 late-command.sh 配置的 deb.debian.org 源）
# - 安装 bash（供 first-start.sh 和 run-service.sh 使用）
...
# ============================================================
# 1. 更新 apt 软件包列表
#    此时 debian.sources 已由 late-command.sh 配置为 deb.debian.org
# ============================================================
...
# ============================================================
# 2. 安装 bash
#    first-start.sh 和 run-service.sh 需要 bash
# ============================================================
